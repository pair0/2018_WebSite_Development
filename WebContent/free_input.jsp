...
<H2>자유 게시판 글쓰기</H2>
<HR>
	[<a href=free_board_list.jsp?action=list>게시판 목록으로</a>] <p>
		<form action="writeAction_free.jsp" method="post" >
  ...
  <tr>
   <tr>
    <th>작성자</th>	
    <td><textarea type="text" class="form-control" placeholder="작성자" name="bbsName" maxlength="15" rows=2 cols=115></textarea></td>
  </tr>
  <tr>
    <th>제 목</th>
  ...
  <tr>
    ...
    <td colspan=2 align=center><input type=submit value="저장"><input type=reset value="취소" onclick="gotrapboardlist()" /></td>
</tr>
</table>
</form>
</div>
