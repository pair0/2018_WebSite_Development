...
<div class="container">
		<div class="row">
<H2>여행 리뷰 글쓰기(아프리카)</H2>
<HR>
	[<a href=trap_board_list_5.jsp?action=list>게시판 목록으로</a>] <p>
		<form action="writeAction_5.jsp" method="post" >
  ...
  <tr>
    ...
    <td colspan=2 align=center><input type=submit value="저장"><input type=reset value="취소" onclick="gotrapboardlist5()" /></td>
</table>
</form>
</div>
</div>
