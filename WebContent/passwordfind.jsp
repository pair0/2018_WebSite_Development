...
<!-- Navigation -->
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-3">
          <h4 class="my-4">아이디/비밀번호 찾기</h4>
          <div class="list-group">
            <a href="idfind.jsp" class="list-group-item">아이디 찾기</a>
            <a href="passwordfind.jsp" class="list-group-item">비밀번호 찾기</a>
          </div>
        </div>
 ...
 <br>
<div class="card my-5">
	<form id="" name="" method="post" action="passwordfindAction.jsp" class="form_login">
            ...
            <div class="col-md-4">
            <input type="button" class="btn-primary form-control" value="로그인" onclick="goLoginForm()" />
            </div>
            <div class="col-md-4">
            <input type="button" class="btn-primary form-control" value="홈페이지" onclick="goHomepageForm()" />
            </div>
            </div>
          </div>
          </form>
