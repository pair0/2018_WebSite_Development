...
function gotrapboardlist3() {
            location.href="trap_board_list_3.jsp";
        }
 </script>
</head>
<body>
...
<div class="container">
		<div class="row">
<H2>여행 리뷰 글쓰기(아시아/오세아니아)</H2>
<HR>
	[<a href=trap_board_list_3.jsp?action=list>게시판 목록으로</a>] <p>
		<form action="writeAction_3.jsp" method="post" >
  ...
  <tr>
    ...
    <td colspan=2 align=center><input type=submit value="저장"><input type=reset value="취소" onclick="gotrapboardlist3()" /></td>
</table>
</form>
</div>
</div>
