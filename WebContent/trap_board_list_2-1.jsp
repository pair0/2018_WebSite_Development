		...
		<table class="table table-hover">
			<thead>
				...
				<%
					...
					System.out.println("11"+bbs.getBbsSearch());
			...
			<%
				if(pageNumber != 1) {
			%>
				<a href="trap_board_list_2-1.jsp?pageNumber=<%=pageNumber-1 %>" class="btn btn-success btn-arraw-left">이전</a>
			<%
				} 
				if(bbsDAO.nextPage(pageNumber+1)) {
			%>
				<a href="trap_board_list_2-1.jsp?pageNumber=<%=pageNumber+1 %>" class="btn btn-success btn-arraw-right">다음</a>
			<%
				}
			%>
			</div>
