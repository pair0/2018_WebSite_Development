  ...
  <!-- username -->
    ...
    <div class="container">
      ...
      <div class="row">
           ...
           <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
              <div class="carousel-item active">      
                <img class="d-block img-fluid" src="images_700x500/유럽2.jpg" alt="First slide">               
              </div>
              <div class="carousel-item">
                <img class="d-block img-fluid" src="images_700x500/유럽4.jpg" alt="Second slide">
              </div>
              <div class="carousel-item">
                <img class="d-block img-fluid" src="images_700x500/유럽3.jpg" alt="Third slide">
              </div>
              <div class="carousel-item">
                <img class="d-block img-fluid" src="images_700x500/유럽1.jpg" alt="Fourth slide">
              </div>
            </div>
		...
		<h3></h3>
          <h3 class="my-3">유럽</h3>
          <p>6대주(六大洲) 가운데 두 번째로 작은 주로, 오세아니아보다 약간 크다. 북쪽은 북극해, 서쪽은 대서양, 남쪽은 지중해로 둘러싸이고, 동쪽은 우랄산맥·우랄강·카스피해·캅카스산맥·흑해·보스포루스 해협을 경계로 아시아 대륙에 접한다. 지형적으로는 유라시아 대륙의 커다란 반도에 불과하나, 정치적·인종적·언어적 개념으로는 아시아 대륙과는 다른 하나의 뚜렷한 특성을 갖는 지역이다.</p>
