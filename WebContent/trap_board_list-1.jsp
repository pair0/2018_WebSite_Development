...
<jsp:setProperty name="bbs" property="bbsSearch" />
<jsp:setProperty name="bbs" property="bbsSearchoption" />
...
<!-- <script type="text/javascript">
   function check(ab_id) {
      ...
      document.location.href="db_control.jsp?action=edit&ab_id="+ab_id+"&upasswd="+pwd;
 	}
</script> -->
	
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<title>여행 리뷰 게시판(북아메리카)</title>
</head>
<body>
<!-- username -->
  	<%
		...
		<div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
              <div class="carousel-item active">      
                <img class="d-block img-fluid" src="images_900x500/USA_5.jpg" alt="First slide">               
              </div>
              <div class="carousel-item">
                <img class="d-block img-fluid" src="images_900x500/USA_2.jpg" alt="Second slide">
              </div>
              <div class="carousel-item">
                <img class="d-block img-fluid" src="images_900x500/USA_4.jpg" alt="Third slide">
              </div>
              <div class="carousel-item">
                <img class="d-block img-fluid" src="images_900x500/USA_3.jpg" alt="Fourth slide">
              </div>
            </div>
...
<hr>
	<div class="container">
		<table class="table table-hovor">
			<thead>
				...
				<%
					...
					for(int i=0; i< list.size(); i++){
						if((bbs.getBbsSearch().equals(list.get(i).getBbsCountry())==true && bbs.getBbsSearchoption().equals("여행한 나라")==true) || 
								(bbs.getBbsSearch().equals(list.get(i).getBbsName())==true && bbs.getBbsSearchoption().equals("작성자")==true) || 
								(bbs.getBbsSearch().equals(list.get(i).getBbsTitle())==true && bbs.getBbsSearchoption().equals("제목")==true)){
					
				%>
				<tr>
					<td><a href="view.jsp?bbsID=<%=list.get(i).getBbsID()%>">  <%= list.get(i).getBbsID()+2 %> </a></td>
					<td><a href="view.jsp?bbsID=<%=list.get(i).getBbsID()%>"> <%= list.get(i).getBbsName().replaceAll("<","&lt").replaceAll(">","&lt").replaceAll(" ","&nbsp").replaceAll("\n","<br>") %></a></td>
			...
			<div class="row">
			<div class="col-md-6">
			<a href="trap_input.jsp" class="btn btn-primary pull-right">글쓰기</a>
			<%
				if(pageNumber != 1) {
			%>
				<a href="trap_board_list-1.jsp?pageNumber=<%=pageNumber-1 %>" class="btn btn-success btn-arraw-left">이전</a>
			<%
				} 
				if(bbsDAO.nextPage(pageNumber+1)) {
			%>
				<a href="trap_board_list-1.jsp?pageNumber=<%=pageNumber+1 %>" class="btn btn-success btn-arraw-right">다음</a>
			<%
				}
			%>
			</div>
			...
			<div class="col-md-6">
			<form method="post" action="trap_board_list-1.jsp">
