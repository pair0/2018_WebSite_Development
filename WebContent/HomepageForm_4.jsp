  ...
  <!-- username -->
    ...
    <div class="container">
      ...
      <div class="row">
           ...
           <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
              <div class="carousel-item active">      
                <img class="d-block img-fluid" src="images_700x500/남아메리카3.jpg" alt="First slide">               
              </div>
              <div class="carousel-item">
                <img class="d-block img-fluid" src="images_700x500/남아메리카2.jpg" alt="Second slide">
              </div>
              <div class="carousel-item">
                <img class="d-block img-fluid" src="images_700x500/남아메리카.jpg" alt="Third slide">
              </div>
              <div class="carousel-item">
                <img class="d-block img-fluid" src="images_700x500/남아메리카4.jpg" alt="Fourth slide">
              </div>
            </div>
		...
		<h3></h3>
          <h3 class="my-3">남아메리카</h3>
          <p>대륙 전반에 걸쳐 길이 약 8500㎞의 안데스 산맥이 솟아있어 서쪽에서는 고산기후가 나타나며, 동쪽은 온대와 열대지역에 해당하여 연중 따뜻한 기후를 보인다. 반면, 칠레와 아르헨티나의 최남단은 남극권에 해당한다. 대부분의 지역이 스페인과 포르투갈의 영향을 받아 대륙전체에서 스페인어와 포르투갈어 두 가지 언어가 통용되고 있다.</p>
