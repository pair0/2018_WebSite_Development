  ...
  <!-- username -->
    ...
    <div class="container">
      ...
      <div class="row">
           ...
           <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
              <div class="carousel-item active">      
                <img class="d-block img-fluid" src="images_700x500/아시아4.jpg" alt="First slide">               
              </div>
              <div class="carousel-item">
                <img class="d-block img-fluid" src="images_700x500/아시아1.jpg" alt="Second slide">
              </div>
              <div class="carousel-item">
                <img class="d-block img-fluid" src="images_700x500/아시아3.jpg" alt="Third slide">
              </div>
              <div class="carousel-item">
                <img class="d-block img-fluid" src="images_700x500/오세아니아.jpg" alt="Fourth slide">
              </div>
            </div>
		...
		<h3></h3>
          <h3 class="my-3">아시아/오세아니아</h3>
          <p>아시아: 아시아란 이름은 본래 그리스인(人)들이 그들 나라의 동쪽에 있는 나라들을 가리킬 때 사용한 ‘아수(asu:동쪽)’라는 아시리아어(語)에서 유래되었다고 한다. 처음에는 고대의 동방, 즉 오리엔트를 가리켰으나 오늘날에는 우랄산맥과 카스피해(海)에서 동쪽으로 태평양 연안에 이르는 유라시아 대륙의 중부와 동부의 전대륙을 포괄한다.
          오세아니아:"오세아니아"는 대양(大洋)이라는 뜻을 가지고 있어 대양주(大洋洲)라고도 한다. 넓은 뜻으로는 오스트레일리아·뉴질랜드·멜라네시아·미크로네시아·폴리네시아를 포함하는 대부분의 태평양 지역의 섬을 뜻한다         
.</p>
          <h3 class="my-3"></h3>여행 지역</h3>
          <ul>
            <li>미국</li>
            <li>유럽</li>
            <li>남아메리카</li>
      ...
      <div class="row">
        <div class="col-md-3 col-sm-6 mb-4">
          <a href="HomepageForm.jsp">
            <img class="img-fluid" src="images_500x300/USA_5.jpg" alt="">
          </a>
        </div>
        <div class="col-md-3 col-sm-6 mb-4">
