...
<body>
	<%
		...
		{	
			BbsDAO_3 bbsDAO_3 = new BbsDAO_3();
			if(bbs.getBbsFileName()!= null)
			{
				result = bbsDAO_3.write(userID, bbs.getBbsCountry(), bbs.getBbsTitle(), bbs.getBbsMemo(), bbs.getBbsFileName(), 0);
			}
			else
			{
				result = bbsDAO_3.write(userID, bbs.getBbsCountry(), bbs.getBbsTitle(), bbs.getBbsMemo(), 0);
			}
			if( result == -1)
			{
				PrintWriter script=response.getWriter();
