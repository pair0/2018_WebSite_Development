  ...
  <!-- username -->
    ...
    <div class="container">
      ...
      <div class="row">
           ...
           <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
              <div class="carousel-item active">      
                <img class="d-block img-fluid" src="images_700x500/아프리카1.jpg" alt="First slide">               
              </div>
              <div class="carousel-item">
                <img class="d-block img-fluid" src="images_700x500/아프리카2.jpg" alt="Second slide">
              </div>
              <div class="carousel-item">
                <img class="d-block img-fluid" src="images_700x500/아프리카3.jpg" alt="Third slide">
              </div>
              <div class="carousel-item">
                <img class="d-block img-fluid" src="images_700x500/아프리카4.jpg" alt="Fourth slide">
              </div>
            </div>
		...
		<h3></h3>
          <h3 class="my-3">아프리카</h3>
          <p>인류의 고향 아프리카는 아시아 다음으로 넓은 대륙이다. 대부분 열대 기후가 나타나 더운 땅이기도 하고, 적도가 지나는 지역은 밀림이 우거져 있고, 북부와 남부에는 거대한 사막이 있으며, 동부에는 고원도 있어서 다양한 기후와 자연환경을 만날 수 있다. </p>
