...
<body>
	<%
		...
		if(bbs.getBbsTitle() == null || bbs.getBbsMemo() == null)
		{
		...
		{	
			...
			{
				result = bbsDAO.write(userID, bbs.getBbsTitle(), bbs.getBbsMemo(), bbs.getBbsFileName(), 0);
			}
			else
			{
				result = bbsDAO.write(userID, bbs.getBbsTitle(), bbs.getBbsMemo(), 0);
			}
