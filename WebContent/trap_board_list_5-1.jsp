		...
		<div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
              <div class="carousel-item active">      
                <img class="d-block img-fluid" src="images_900x500/아프리카1.jpg" alt="First slide">               
              </div>
              <div class="carousel-item">
                <img class="d-block img-fluid" src="images_900x500/아프리카2.jpg" alt="Second slide">
              </div>
              <div class="carousel-item">
                <img class="d-block img-fluid" src="images_900x500/아프리카3.jpg" alt="Third slide">
              </div>
              <div class="carousel-item">
                <img class="d-block img-fluid" src="images_900x500/아프리카4.jpg" alt="Fourth slide">
              </div>
            </div>
	...
	<div class="container">
		<table class="table table-hovor">
			<thead>
				...
				%>
				<tr>
					<td><a href="view_5.jsp?bbsID=<%=list.get(i).getBbsID()%>">  <%= list.get(i).getBbsID()+2 %> </a></td>
					<td><a href="view_5.jsp?bbsID=<%=list.get(i).getBbsID()%>"> <%= list.get(i).getBbsName().replaceAll("<","&lt").replaceAll(">","&lt").replaceAll(" ","&nbsp").replaceAll("\n","<br>") %></a></td>
			...
			<div class="row">
			<div class="col-md-6">
			<a href="trap_input_5.jsp" class="btn btn-primary pull-right">글쓰기</a>
			<%
				if(pageNumber != 1) {
			%>
				<a href="trap_board_list_5-1.jsp?pageNumber=<%=pageNumber-1 %>" class="btn btn-success btn-arraw-left">이전</a>
			<%
				} 
				if(bbsDAO.nextPage(pageNumber+1)) {
			%>
				<a href="trap_board_list_5-1.jsp?pageNumber=<%=pageNumber+1 %>" class="btn btn-success btn-arraw-right">다음</a>
			<%
				}
			%>
			</div>
			...
			<div class="col-md-6">
			<form method="post" action="trap_board_list_5-1.jsp">
