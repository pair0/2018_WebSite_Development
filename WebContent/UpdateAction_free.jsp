...
<body>
	<%
		...
		if(request.getParameter("bbsTitle") == null || request.getParameter("bbsMemo") == null)
		{
		...
		else
		{
			...
			{
				result = bbsDAO.update(bbsID, request.getParameter("bbsTitle"), request.getParameter("bbsMemo"));
			}
			else
			{
				result = bbsDAO.update(bbsID, request.getParameter("bbsTitle"), request.getParameter("bbsMemo"), request.getParameter("bbsFileName"));
			}
